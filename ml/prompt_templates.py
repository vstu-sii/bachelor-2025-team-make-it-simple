...
2. Каждому узлу присвой уникальный id (строка)
3. Создай связи (edges) между узлами, показывающие зависимости
...
2. Удели особое внимание указанным пробелам в знаниях
3. Используй примеры, связанные с интересами студента
4. Включи основные правила, структуры и исключения
5. Добавь 3-5 примеров предложений
6. Используй русский язык для объяснений, но английский для примеров
7. Разделяй контент на логические части с помощью \\n\\n
...
3. Используй грамматику и лексику текущей темы урока
4. Текст должен быть увлекательным и информативным
5. Добавь 3-4 вопроса на понимание текста
6. Вопросы должны быть на английском языке
7. Вопросы должны проверять понимание деталей текста
...
3. Упражнение должно практиковать грамматику и лексику текущей темы
4. Дай четкие и конкретные инструкции студенту
5. Включи пример ответа для вдохновения
6. Укажи рекомендуемую продолжительность речи (2-3 минуты)
...
3. Вопросы должны практиковать указанные пробелы в знаниях
4. Используй разные типы вопросов: single_choice, multiple_choice, short_answer
5. Включи вопросы с примерами из интересов студента
6. Все ответы должны быть правильными и соответствовать теме
...
2. Определи основные пробелы в знаниях студента
3. Оцени понимание темы по шкале от 1 до 10
4. Дай конструктивную обратную связь на русском языке
5. Рекомендуй, нужен ли дополнительный урок по этой теме
