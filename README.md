...
**Результат**: При подтверджении на экране открывается страница ученика с новыми данными; В базе данных системы обновляются данные ученика.
...
**Результат**: При подтверждении экране открывается страница ученика с новыми данными; В базе данных системы обновляются данные ученика.

### UC - Генерация задач по записи в календаре

**Акторы**: Пользователь (репетитор)
...
### UC - Генерация задач по ученику из списка в приложении
