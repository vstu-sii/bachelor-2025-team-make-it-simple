...
### UC1 - Ручная регистрация ученика в системе

**Акторы**: *пользователь* (*репетитор*), *система* (*AI MEETING HERO*).

**Предусловия**:
- Пользователь (репетитор) авторизован в системе.

**Сценарий**:
1. Пользователь жмёт на кнопку "Добавить ученика", после чего открывается страница редактирования ученика;
2. Пользователь заполняет обязательные поля: ФИО;
3. Пользователь заполняет необязательные поля: контактные данные, возраст и класс обучения, интересы, индивидуальные особенности;
