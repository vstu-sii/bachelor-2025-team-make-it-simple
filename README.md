...
1. Если фио не нашлось, система выведет найденные данные и предложит либо вписать фио вручную, либо выбрать другое событие;
1. Пользователь выполнит запрос системы и нажмёт "подтвердить".
