...
- [Инструкция по запуску проекта](#запуск-проекта);
...
## Запуск всего сервиса в тестовом режиме

```
docker compose up -d
```

## Запуск отдельных сервисов проетка

- [Backend](backend/README.md#запуск)
- [Frontend](frontend/README.md#запуск)
- [LLM](ml/README.md#запуск)

# Структура проекта

├─ api - openapi спецификация\
├─ backend - бэкенд сервис\
│&nbsp;&nbsp;&nbsp;&nbsp;└─ [подробнее](backend/README.md#структура)\
├─ data - ранние примеры данных\
│&nbsp;&nbsp;&nbsp;&nbsp;├─ datasets - датасеты для проверки ллм моделей\
│&nbsp;&nbsp;&nbsp;&nbsp;└─ sample_course_materials - примеры материалов курса\
├─ database - ранняя структура БД\
├─ design - дизайн приложения и пользовательский путь\
├─ docs - вся документация проекта (кроме этого файла)\
│&nbsp;&nbsp;&nbsp;&nbsp;└─ assets - изображения и исходные файлы, используемые в документации\
├─ frontend - фронтенд сервис\
│&nbsp;&nbsp;&nbsp;&nbsp;└─ [подробнее](frontend/README.md#структура)\
├─ ml - ллм сервис\
│&nbsp;&nbsp;&nbsp;&nbsp;└─ [подробнее](ml/README.md#структура)\
├─ monitoring - всё для мониторинга проекта\
│&nbsp;&nbsp;&nbsp;&nbsp;├─ grafana - конфиг\
│&nbsp;&nbsp;&nbsp;&nbsp;└─ prometheus - конфиг\
└─ reports - отчёт о подборе модели
