...
## Цель проекта
  ...
  Повысить качество и эффективность подготовки репетиторов к занятиям через автоматическое обогащение профилей учеников и использование AI для персонализации учебного материала, что сокращает время подготовки и улучшает образовательные результаты учащихся.
...
## 1. Какую проблему мы решаем?
  ...
  Система также помогает в том случае, если ученик не усвоил какую-то тему по заранее составленному плану. Задания корректируются с учётом ошибок или успехов ученика. Это позволяет повторять пройденные темы или углубляться в них вновь. В этом случае каждая тема будет отработана на хорошем уровне.
