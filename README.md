...
**Актор**: Пользователь (репетитор), Система (AI MEETING HERO)
...
### UC - Добавление ученика из календаря

**Актор**: Пользователь (репетитор), Система (AI MEETING HERO), Календарь (Google/Microsoft/Apple/Caldav), LLM сервис
...
1. Пользователь жмёт "добавить ученика";
1. Система отправляет всю информацию из событие 

**Результат**:

### UC - Ручное изменение интересов ученика

**Актор**: Пользователь (репетитор)
